...
<html>
<head>
	<title>Home-College Of Engineering</title>
	<link rel="shortcut icon" href="../images/icbs_logo.jpg" type="image/x-icon">
...
<nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
	<a class="navbar-brand d-flex align-items-center" href="index.php">
		<img src="images/icbs_logo.jpg" class="logo-image" width="50" height="50">
		<h3 class="text-light text-uppercase ml-2">Government Collage of Engineering Jalgaon</h3>
	</a>
