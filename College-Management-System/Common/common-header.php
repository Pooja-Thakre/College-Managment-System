...
<html lang="en">
	<head>
    <meta charset="utf-8">
    <link rel="shortcut icon" href="$baseUrl/../images/icbs_logo.jpg" type="image/x-icon">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
      <a class="navbar-brand d-flex align-items-center" href="../index.php">
        ...
        <h3 class="text-light text-uppercase ml-2">GOVERNMENT COLLAGE OF ENGINEERING JALAGAON</h3>
      </a>
